...
> Статус: архитектура и расчёты проверены на синтетических данных. Полный прогон
> набора 2010–2023 и публикация итоговых показателей запланированы отдельным
...
После полного прогона в этом разделе появятся проверенные выводы и ссылки на
соответствующие таблицы и визуализации.
